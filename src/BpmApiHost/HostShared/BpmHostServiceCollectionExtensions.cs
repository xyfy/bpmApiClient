...
namespace BpmApiHost.HostShared
{
    /// <summary>
    /// BpmApiHost 在 .NET Core 2.2 / 3.1 下共用的服务注册逻辑。
    /// </summary>
    public static class BpmHostServiceCollectionExtensions
    {
        public static IServiceCollection AddBpmHostCoreServices(
